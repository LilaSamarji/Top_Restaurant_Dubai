fetch('https://restaurants-api-u1o9.onrender.com')
      ...
      .then(restaurants =>{
            ...
            restaurants.forEach(restaurant=>{
                ...
                cards.innerHTML=`
                <div class="card" style="width:18rem;height:27rem;margin:3rem;">
                <img class="card-img-top" src="${restaurant.Picture}" alt="Card image cap" style="width:100%;">
                <div class="card-body" style="background-color:#FEF5E7 ;height:60%;">
                <div  style="color:black ;margin-top:0.3vw;margin-bottom:3vw;"><span style="font-weight:bold;color:#B22222;font-size:1.2vw;">Location</span> <p style="font-size:1.5vw; margin-top:0.3vw;margin-bottom:0.2vw;color:black;margin-left:0.2vw" >  ${restaurant.Location}</p> </div>
